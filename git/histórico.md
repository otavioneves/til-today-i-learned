Para verificar o histórico de um repositório usamos o `git log`. Esse comando apresenta algumas informações como o hash dos commits, o autor, a data e o título do commit.<br>
